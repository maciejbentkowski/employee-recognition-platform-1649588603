...
Kudo.create!(title: "sample title number 5", content: "sample content number 5", giver_id: 3, receiver_id: 3)
Kudo.create!(title: "sample title number 6", content: "sample content number 6", giver_id: 3, receiver_id: 3)
Kudo.create!(title: "sample title number 7", content: "sample content number 7", giver_id: 4, receiver_id: 2)
